...
<div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 mx-auto container">
	<div class="profile col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 my-auto text-center">
		<button name="sortA-Z" data-sort="aplhaAsc" data-function="sort" onclick="sort('sortAplhabeticAsc')" class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 sortButton">A-Z</button>
		<button name="sortZ-A" data-sort="aplhaDesc" data-function="sort" onclick="sort('sortAplhabeticDesc')" class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 sortButton">Z-A</button>
		<button name="sort1970-2000" data-sort="dateAsc" data-function="sort" onclick="sort('sortDateAsc')" class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 sortButton">Date asc</button>
		<button name="sort2000-1970" data-sort="dateDesc" data-function="sort" onclick="sort('sortDateDesc')" class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 sortButton">Date desc</button>
		<button name="sortFAV" data-sort="fav" data-function="sort" onclick="sort('sortFav')" class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 sortButton">Favourite</button>
		...
		<div class="settings">
			...
			<a href="#" onclick="window.location.replace('delete-user');">Delete account</a>
		</div>
	</div>
...
<script>
	function sort(type) {
		...
		$.ajax({
			url: 'http://localhost/Phonebook/Vendor/cakephp/cakephp/'+type,
			dataType: 'json',
